...
export const useChat = (
    ...
    const [chatFormData, setChatFormData] = useState<ChatFormDataInputs>(initialChatData)
    ...
    const handleFileUpload = async(file:string) => {
        ...
        const response = await axios.post("http://localhost:4000/api/core/uploadImage", { avatar: file }, {
            headers: {
